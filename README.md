...
```
ros2 launch insta360_ros_driver bag_record.launch.py
```
...
```
ros2 launch insta360_ros_driver bag_compress.launch.py
```
...
```
ros2 launch insta360_ros_driver bag_undistort.launch.py
```
...
```
ros2 launch insta360_ros_driver bag_preview.launch.py
```
